...
$nsgRule1 = New-AzNetworkSecurityRuleConfig -Name "Allow-SSH" -Access Allow -Protocol Tcp `
    -Direction Inbound -Priority 120 -SourceAddressPrefix Internet -SourcePortRange * `
    -DestinationAddressPrefix 10.0.0.0/24 -DestinationPortRange 22
...
# Set the operating system for the Virtual Machine to Linux using the specified credentials
Set-AzVMOperatingSystem -VM $vmConfig -ComputerName $vmName -Credential $Credential -Linux 

# Set the source image for the Virtual Machine to Linux Server
