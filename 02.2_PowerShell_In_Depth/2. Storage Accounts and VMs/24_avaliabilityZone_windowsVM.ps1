...
# Create a new Azure Public IP address with static allocation and avaliability zone 1
...
# Create a new Azure VM configuration and adding it to avaliability zone 1
$vmConfig = New-AzVMConfig -Name $vmName -VMSize $VMSize -Zone 1
